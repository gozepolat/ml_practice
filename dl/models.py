...
def construct_cnn_lstm(stateful=True,loss='categorical_crossentropy', border_mode='valid', activation='relu',
...
def train_model(model, X_train, y_train, X_test, y_test, nb_epoch=2, batch_size=30, patience=2):
